...
def adjust_baz_for_ZEN(baz_original):
    """
    Adjusts the BAZ (Back-Azimuth) to the ZEN system (swap N and E).

    Parameters:
    -----------
    baz_original : float
        Back-azimuth in the ZNE system (in degrees, 0° to 360°).

    Returns:
    --------
    float
        New BAZ in the ZEN system (in degrees, 0° to 360°).
    """

    baz_ZEN = baz_original - 90
    # Adjusts to interval [0°, 360°)
    baz_ZEN = baz_ZEN % 360
    return baz_ZEN
