...
def calculate_metrics(input_lst):
    ...
    None
        ...
        ORIENTATION_OUTPUT/FEATHER_FILES/ORIENTATION/{NETWORK}.{STATION}/
        The file contains a DataFrame with waveform segments, orientation results (phi, theta), SNR, and event metadata.
    """
